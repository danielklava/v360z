...
var MateriaisComponent = /** @class */ (function () {
    function MateriaisComponent() {
        this.search = "";
        this.materiais2 = [
            { matnr: '90000158', maktx: '901770 (Emb. contém 1un. ) ', maktg: 'PRD001', qnt: "90", centro: "1052" },
            { matnr: '90000164', maktx: '914190 (Emb. contém 1un. ) ', maktg: 'PRD002 ', qnt: "12", centro: "1101" },
            { matnr: '90000633', maktx: '900108 (Emb. contém 1un. ) ', maktg: 'PRD003', qnt: "85", centro: "1004" },
            { matnr: '90002074', maktx: '900083 (Emb. contém 1un. ) ', maktg: 'PRD004', qnt: "15", centro: "1004" },
            { matnr: '90002093', maktx: '900107 (Emb. contém 1un. ) ', maktg: 'PRD005', qnt: "45", centro: "1004" },
        ];
        this.materiais = [
            ...
            { matnr: '90002074', maktx: '900083 (Emb. contém 1un. ) ', maktg: 'PRD004', qnt: "15", centro: "1004" },
            { matnr: '90002093', maktx: '900107 (Emb. contém 1un. ) ', maktg: 'PRD005', qnt: "45", centro: "1004" },
            { matnr: '90000158', maktx: '901770 (Emb. contém 1un. ) ', maktg: 'PRD006', qnt: "90", centro: "1052" },
            { matnr: '90000164', maktx: '914190 (Emb. contém 1un. ) ', maktg: 'PRD007', qnt: "12", centro: "1101" },
            { matnr: '90000633', maktx: '900108 (Emb. contém 1un. ) ', maktg: 'PRD008', qnt: "85", centro: "1004" },
            { matnr: '90002074', maktx: '900083 (Emb. contém 1un. ) ', maktg: 'PRD009', qnt: "15", centro: "1004" },
            { matnr: '90002093', maktx: '900107 (Emb. contém 1un. ) ', maktg: 'PRD010', qnt: "45", centro: "1004" }
        ];
    }
...
module.exports = "<div class=\"item\">\n  <span class=\"title\" >\n    <span>{{item.title}}</span>\n  </span>\n  \n  <span class=\"graph\" [ngStyle]=\"{'color': item.color}\">\n    <i class=\"fa {{item.icon}} fa-2x {{fontBounce}}\" aria-hidden=\"true\"></i>\n  </span>\n  \n\n  <span class=\"value\">\n    <span *ngIf=\"item.title != 'Status Abastecimento'\" class=\"{{fontSize}}\">{{item.value}}</span>\n\n    <span *ngIf=\"item.title == 'Status Abastecimento'\">\n        OK\n    </span>\n    \n\n  </span>\n  \n</div>"
...
var ClientsService = /** @class */ (function () {
    function ClientsService() {
        ...
        cliente1.email = "victor.serra@partners.digital";
        ...
        cliente1.id = "1010370";
        cliente1.name = "Cliente SAP";
        cliente1.razao = "Cliente SAP";
        cliente1.cnpj = "45.645.193/001-98";
